...
export default function TopAppBar({ title, subtitle, onBellPress }: TopAppBarProps) {
  ...
  return (
    <>
      <header className="fixed top-0 w-full max-w-[430px] z-50 bg-surface-container header-safe dark:border-b dark:border-white/5">
        <div className="flex justify-between items-center px-6 py-4 animate-fade-in">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="w-9 h-9 rounded-full bg-surface-container-low bento-shadow-sm flex items-center justify-center text-on-surface-variant hover:opacity-70 active:scale-95 transition-all duration-150"
              aria-label="Cài đặt"
            >
